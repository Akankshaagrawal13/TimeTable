<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trans5.aspx.cs" Inherits="trans5" %>
...
<link rel="Stylesheet" type="text/css" href="StyleSheet.css" />
 ...
 <body class="body">
<font color="white" size="10">Class Wise Entry</font> 
 ...
 <table class="tablehead">
   ...
   <br />
    ...
    <td class="style60" align="center">
        <asp:Label ID="Label8" runat="server" Text="Room No." Font-Size="X-Large" 
            ForeColor="White"></asp:Label>
    </td>
    ...
    <td class="style23" align="center">
        ...
        <asp:DropDownList ID="TIMELIST" runat="server" AutoPostBack="True" 
            ...
            <asp:ListItem Value="0">06:00AM-07:00 AM</asp:ListItem>
            <asp:ListItem Value="1">07:00AM-08:00 AM</asp:ListItem>
            <asp:ListItem Value="2">8:00-9 AM</asp:ListItem>
            <asp:ListItem Value="3">09:00AM-10:00AM</asp:ListItem>
            <asp:ListItem Value="4">10:00AM-11:00AM</asp:ListItem>
            <asp:ListItem Value="5">11:00AM-12:00AM</asp:ListItem>
            <asp:ListItem Value="6">12:00AM-01:00AM</asp:ListItem>
            <asp:ListItem Value="7">01:00AM-02:00AM</asp:ListItem>
            <asp:ListItem Value="8">02:00AM-03:00AM</asp:ListItem>
            <asp:ListItem Value="9">03:00AM-04:00AM</asp:ListItem>
            <asp:ListItem Value="10">04:00AM-05:00AM</asp:ListItem>
            <asp:ListItem Value="11">05:00AM-06:00AM</asp:ListItem>
            <asp:ListItem Value="12">06:00AM-07:00AM</asp:ListItem>
            <asp:ListItem Value="13">07:00AM-08:00AM</asp:ListItem>
            <asp:ListItem Value="14">8-9 PM</asp:ListItem>
        </asp:DropDownList>
    </td>
